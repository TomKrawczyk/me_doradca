...
{ label: '5. Roczne zużycie / eksport:', value: `1.8.0: ${data.energiaPobrana || 'Nie podano'} kWh | 2.8.0: ${data.energiaOddana || 'Nie podano'} kWh` },
{ label: '6. Ocena autokonsumpcji:', value: data.ocenaAutokonsumpcji || 'Nie podano' },
{ label: '7. Kontrola paneli:', value: data.kontrolaPaneli || 'Nie podano' },
{ label: '8. Kontrola mocowań:', value: data.kontrolaMocowan || 'Nie podano' },
{ label: '9. Przewody DC/AC:', value: data.kontrolaPrzewodow || 'Nie podano' },
{ label: '10. Zabezpieczenia:', value: data.stanZabezpieczen || 'Nie podano' },
{ label: '11. Odczyt falownika:', value: data.odczytFalownika || 'Nie podano' },
{ label: '12. Uziemienie:', value: data.kontrolaUziemienia || 'Nie podano' },
{ label: '13. Możliwości rozbudowy:', value: data.mozliwosciRozbudowy || 'Nie podano' },
{ label: '14. Potencjał modernizacji:', value: data.kalkulacjaPotencjalu || 'Nie podano' },
